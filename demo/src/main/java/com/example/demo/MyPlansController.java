...
public class MyPlansController extends Application implements Initializable {
    @FXML
    ...
    @FXML
    private static Button goToPlanView;
    @FXML
    ...
    @FXML
    private ScrollPane createdPlansScreen;
    @FXML
    private ScrollPane joinedPlansScreen;
    @FXML
    private Button goToJoinedPlans;
    @FXML
    private Button goToCreatedPlans;
    @FXML
    private Stage stage;
    @FXML
    private Scene scene;
    ...
    @FXML
    protected void setGoToPlanView(ActionEvent event) throws IOException{
        Parent root = FXMLLoader.load(Application.class.getResource("View_plan.fxml"));
        stage = (Stage)((Node)event.getSource()).getScene().getWindow();
        scene = new Scene(root);
        root.setOnMousePressed(new EventHandler<javafx.scene.input.MouseEvent>() {
            @Override
...
//        userName.setText(STR."@\{UserInfo.userName}");
        ...
        goToJoinedPlans.setOnMouseClicked(event -> {
            createdPlansScreen.setVisible(false);
            joinedPlansScreen.setVisible(true);
        });

        goToCreatedPlans.setOnMouseClicked(event -> {
            joinedPlansScreen.setVisible(false);
            createdPlansScreen.setVisible(true);
        });
    }
}
